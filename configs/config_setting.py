...
class setting_config:
    ...
    """
    network = 'UltraLight_CrackNet' #'UltraLight_CrackNet', 'U_Net', 'SegNet', 'DeepCrack', 'Deeplabv3_plus', 'TransUNet', 'Efficientnet', 'Mobilenetv3', 'LinkCrack', 'HrSegNetB48', 'CrackSegFormer'
    model_config = {
        'num_classes': 1,
        'input_channels': 3,
    ...
    datasets = 'SteelCrack'  # 'SteelCrack' 'DeepCrack' 'Crack500'

    criterion = BceDiceLoss(wb=1, wd=1)

    pretrained_path = './pre_trained/'
    num_classes = 1
    input_size_h = 512  # 'DeepCrack' 'Crack500' -> 384×384
    input_size_w = 512
    input_channels = 3
    distributed = False
    local_rank = -1
    ...
    print_interval = 413  # 训练模型时使用，训练完一轮后打印训练信息， 3300 / 8 = 413   300 / 8 = 38   1896 / 8 = 237
    val_interval = 10
    save_interval = 106  # 保存测试结果图片的间隔，530 / 106 = 5   187 / 37 = 5   1124 / 224 = 5一共保存5张测试结果图
    threshold = 0.5
    ...
    if opt == 'Adadelta':
        ...
        lr = 0.006 # default: 1e-3 – learning rate
